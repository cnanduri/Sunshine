...
import app.udacity.android.cn.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                ContentResolver resolver = mContext.getContentResolver();
                inserted = resolver.bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(new ContentValues[cVVector.size()]));
            }
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error " + e.getMessage(), e.getCause());
