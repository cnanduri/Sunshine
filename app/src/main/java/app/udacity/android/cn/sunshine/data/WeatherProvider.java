...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        final String pathWeather = WeatherContract.PATH_WEATHER;
        final String pathLocation = WeatherContract.PATH_LOCATION;

        // 2) Use the addURI function to match each of the types.  Use the constants from
        // WeatherContract to help define the types to the UriMatcher.
        sURIMatcher.addURI(authority, pathWeather, WEATHER);
        sURIMatcher.addURI(authority, pathWeather + "/*", WEATHER_WITH_LOCATION);
        sURIMatcher.addURI(authority, pathWeather + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        sURIMatcher.addURI(authority, pathLocation, LOCATION);
